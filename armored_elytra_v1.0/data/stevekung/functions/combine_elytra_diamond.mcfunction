summon item ~ ~ ~ {Item:{id:"minecraft:elytra",Count:1b,tag:{IsArmoredElytra:1b,IsDiamondElytra:1b,display:{Name:"{\"text\":\"Armored Elytra (Diamond)\",\"color\":\"yellow\",\"italic\":\"false\"}"},AttributeModifiers:[{AttributeName:"generic.armor",Name:"Armor",UUIDMost:39573,UUIDLeast:127301,Amount:8,Slot:"chest"},{AttributeName:"generic.armorToughness",Name:"Toughness",UUIDMost:30178,UUIDLeast:156274,Amount:2,Slot:"chest"}]}}}
