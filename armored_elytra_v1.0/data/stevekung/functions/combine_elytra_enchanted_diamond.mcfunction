summon item ~ ~ ~ {Item:{id:"minecraft:elytra",Count:1b,tag:{IsArmoredElytra:1b,IsDiamondElytra:1b,Enchantments:[{id:"protection",lvl:4s}],display:{Name:"{\"text\":\"Armored Elytra (Diamond)\",\"color\":\"yellow\",\"italic\":\"false\"}"},AttributeModifiers:[{AttributeName:"generic.armor",Name:"Armor",UUIDMost:54260,UUIDLeast:127904,Amount:8,Slot:"chest"},{AttributeName:"generic.armorToughness",Name:"Toughness",UUIDMost:92737,UUIDLeast:188942,Amount:2,Slot:"chest"}]}}}
