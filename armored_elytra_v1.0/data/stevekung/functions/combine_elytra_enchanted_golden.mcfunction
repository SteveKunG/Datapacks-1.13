summon item ~ ~ ~ {Item:{id:"minecraft:elytra",Count:1b,tag:{IsArmoredElytra:1b,IsGoldenElytra:1b,Enchantments:[{id:"protection",lvl:4s}],display:{Name:"{\"text\":\"Armored Elytra (Golden)\",\"color\":\"yellow\",\"italic\":\"false\"}"},AttributeModifiers:[{AttributeName:"generic.armor",Name:"Armor",UUIDMost:47173,UUIDLeast:119308,Amount:5,Slot:"chest"}]}}}
