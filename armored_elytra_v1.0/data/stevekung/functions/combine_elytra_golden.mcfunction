summon item ~ ~ ~ {Item:{id:"minecraft:elytra",Count:1b,tag:{IsArmoredElytra:1b,IsGoldenElytra:1b,display:{Name:"{\"text\":\"Armored Elytra (Golden)\",\"color\":\"yellow\",\"italic\":\"false\"}"},AttributeModifiers:[{AttributeName:"generic.armor",Name:"Armor",UUIDMost:81338,UUIDLeast:135130,Amount:5,Slot:"chest"}]}}}
