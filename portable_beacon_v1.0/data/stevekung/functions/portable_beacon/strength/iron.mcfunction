summon item ~ ~ ~ {Item:{id:"minecraft:gold_ingot",Count:1b,tag:{StrengthBeacon:1b,HasApplyRegen:0b,HasApplyEffect:1b,IsCompressedBeacon:1b,IsIronBeacon:1b,Enchantments:[{}],display:{Name:"{\"text\":\"Portable Beacon\",\"color\":\"aqua\",\"italic\":\"false\"}",Lore:["§7§oIron Block", "§7Strength II"]}}}}
