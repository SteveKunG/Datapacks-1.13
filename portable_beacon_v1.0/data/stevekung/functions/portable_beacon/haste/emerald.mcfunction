summon item ~ ~ ~ {Item:{id:"minecraft:gold_ingot",Count:1b,tag:{HasteBeacon:1b,HasApplyRegen:0b,HasApplyEffect:1b,IsCompressedBeacon:1b,IsEmeraldBeacon:1b,Enchantments:[{}],display:{Name:"{\"text\":\"Portable Beacon\",\"color\":\"aqua\",\"italic\":\"false\"}",Lore:["§7§oEmerald Block", "§7Haste II"]}}}}
