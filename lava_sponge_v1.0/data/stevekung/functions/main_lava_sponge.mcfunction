# create lava sponge
execute as @e[type=item,nbt=!{Item:{tag:{IsLavaSponge:1b}}},nbt={Item:{id:"minecraft:wet_sponge",Count:1b}}] at @s if entity @e[type=item,nbt={Item:{id:"minecraft:magma_block",Count:1b}},distance=..0.5] if entity @e[type=item,nbt={Item:{id:"minecraft:blaze_powder",Count:1b}},distance=..0.5] run function stevekung:lava_sponge
