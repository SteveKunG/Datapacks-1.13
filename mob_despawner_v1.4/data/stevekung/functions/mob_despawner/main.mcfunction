...
# destroy if invalid
execute as @e[type=armor_stand,tag=mob_despawner] at @s unless block ~ ~1 ~ end_rod[facing=down] run function stevekung:mob_despawner/despawner_destruction
execute as @e[type=armor_stand,tag=mob_despawner] at @s unless block ~ ~ ~ end_rod[facing=up] run function stevekung:mob_despawner/despawner_destruction
execute as @e[type=armor_stand,tag=mob_despawner] at @s unless block ~ ~-1 ~ iron_block run function stevekung:mob_despawner/despawner_destruction
execute as @e[type=armor_stand,tag=mob_despawner] at @s unless block ~ ~-2 ~ diamond_block run function stevekung:mob_despawner/despawner_destruction
execute as @e[type=armor_stand,tag=mob_despawner] at @s unless block ~ ~-3 ~ redstone_lamp run function stevekung:mob_despawner/despawner_destruction
execute as @e[type=armor_stand,tag=mob_despawner] at @s unless entity @e[type=armor_stand,tag=despawner_decor,nbt={ArmorItems:[{},{},{},{id:"minecraft:creeper_head",Count:1b}]},distance=..3.5,limit=1] run function stevekung:mob_despawner/despawner_destruction
execute as @e[type=armor_stand,tag=mob_despawner] at @s unless entity @e[type=armor_stand,tag=despawner_decor,nbt={ArmorItems:[{},{},{},{id:"minecraft:zombie_head",Count:1b}]},distance=..3.5,limit=1] run function stevekung:mob_despawner/despawner_destruction
execute as @e[type=armor_stand,tag=mob_despawner] at @s unless entity @e[type=armor_stand,tag=despawner_decor,nbt={ArmorItems:[{},{},{},{id:"minecraft:skeleton_skull",Count:1b}]},distance=..3.5,limit=1] run function stevekung:mob_despawner/despawner_destruction
execute as @e[type=armor_stand,tag=mob_despawner] at @s unless entity @e[type=armor_stand,tag=despawner_decor,nbt={ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b}]},distance=..3.5,limit=1] run function stevekung:mob_despawner/despawner_destruction
...
# despawn mobs
execute as @e[type=armor_stand,tag=mob_despawner_creative,scores={cdespawner.ticks=0}] at @s run function stevekung:mob_despawner/despawning_mobs_creative
