...
execute as @e[type=item_frame,tag=center_dummy,distance=..1.5,limit=1] at @s run summon armor_stand ~ ~ ~ {Tags:["adv_crafting_table"],Marker:1b,NoGravity:1b,Invisible:1b,Small:1b}
